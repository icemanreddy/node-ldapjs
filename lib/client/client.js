...
Client.prototype.connect = function connect() {
  ...
  function connectSocket(cb) {
    ...
    if (self.secure) {
      socket = tls.connect({port:port, host:self.host, localPort:self.localPort,ca:self.tlsOptions});
      socket.once('secureConnect', onConnect);
    } else {
      socket = net.connect({ port: port,localPort: self.localPort,host: self.host });
